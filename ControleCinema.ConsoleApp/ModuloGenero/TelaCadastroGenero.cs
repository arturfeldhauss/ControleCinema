...
namespace ControleCinema.ConsoleApp.ModuloFuncionario
{
    public class TelaCadastroGenero : TelaBase, ITelaCadastravel
    {
        ...
        public void Inserir()
        {
            MostrarSessao("Cadastro de Gênero de Filme");
        ...
        public void Editar()
        {
            MostrarSessao("Editando Gênero de Filme");
        ...
        public void Excluir()
        {
            MostrarSessao("Excluindo Gênero de Filme");
        ...
        public bool VisualizarRegistros(string tipoVisualizacao)
        {
            if (tipoVisualizacao == "Tela")
                MostrarSessao("Visualização de Gêneros de Filme");
